    ...
    <div class="flex">
        <div class="sidebar w-64 bg-white shadow-md h-screen">
            <div class="sidebar-logo p-4 border-b">
                <img src="/project_ttcsn/img/indeximg/image.png" alt="Logo" class="h-10 mx-auto">
            </div>
            <nav class="sidebar-nav mt-4">
                <ul>
                    ...
                    <li class="p-2 hover:bg-gray-100 cursor-pointer ">
                        <a href="http://localhost/project_ttcsn/User_dash/dashboard.php" class="flex items-center" target="_blank">
