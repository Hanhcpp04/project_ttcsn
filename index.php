...
<body>
    <header>
        <div id="banner">
            <div class="logo-container">
                <div class="logo">
                    <img id="logo" src="/project_ttcsn/img/indeximg/image.png">
                </div>
                <div class="web_name">
            ...
            <div class="menu">
                <ul>
                    <li style="width: 140px;"><a href="index.php"><i class="fa-solid fa-house"></i> Trang Chủ</a></li>
        ...
        <div class="form_Account">
            <button type="button" style="background-color: rgb(0, 228, 255);" onclick="window.location.href='http://localhost/project_ttcsn/auth/login.php'">Bạn đã có tài khoản</button>
            <p>Bạn chưa có tài khoản? <a href="http://localhost/project_ttcsn/auth/register.php">Đăng ký</a> ngay</p>
        </div>
        <div class="bamien">
            <div id="mb"><a href="http://localhost/project_ttcsn/logged_in_user/mienbac.php">MIỀN BẮC</a></div>
            <div id="mt"><a href="http://localhost/project_ttcsn/logged_in_user/mientrung.php">MIỀN TRUNG</a></div>
            <div id="mn"><a href="http://localhost/project_ttcsn/logged_in_user/miennam.php">MIỀN NAM</a></div>
        </div>
    </header>
    ...
    <div class="slider">
        <div class="slides">
            <div class="slide"><img src="/project_ttcsn/img/indeximg/slide1.jpg" alt="Slide 1"></div>
            <div class="slide"><img src="/project_ttcsn/img/indeximg/slide2.jpg" alt="Slide 2"></div>
            <div class="slide"><img src="/project_ttcsn/img/indeximg/slide3.jpg" alt="Slide 3"></div>
            <div class="slide"><img src="/project_ttcsn/img/indeximg/slide4.jpg" alt="Slide 4"></div>
            <div class="slide"><img src="/project_ttcsn/img/indeximg/slide5.jpg" alt=""></div>
            <div class="slide"><img src="/project_ttcsn/img/indeximg/slide6.jpg" alt=""></div>
            <div class="slide"><img src="/project_ttcsn/img/indeximg/slide7.jpg" alt=""></div>
        </div>
            ...
            <?php if (!empty($tours)): ?>
                <?php foreach ($tours as $tour): ?>
                    <div class="swiper-slide">
                        <div class="box">
                            <div class="imgBox">
                                <img src="/project_ttcsn/tours/uploads/<?= htmlspecialchars(str_replace('uploads/', '', $tour['img'])) ?>"
