...
<header>
    <div id="banner">
        ...
        <div class="menu">
            <ul>
                <li style="width: 140px;"><a href="http://localhost/project_ttcsn/User_dash/dashboard.php"><i class="fa-solid fa-house"></i> Trang Chủ</a></li>
                <ul>
                    <?php if (isset($_SESSION['UserID'])): ?>
                        <li><a href="http://localhost/project_ttcsn/feedback/feedback.php"><i class="fa-solid fa-layer-group"></i> Đánh giá</a></li>
                        <li><a href="http://localhost/project_ttcsn/booking/my_tour.php"><i class="fa-solid fa-newspaper"></i> Tour</a></li>
                    <?php else: ?>
                ...
                <?php if (isset($user['Email']) && !empty($user['Email'])): ?>
                    ...
                    <li id="menu">
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="http://localhost/project_ttcsn/auth/ChangeMK.php">Đổi mật khẩu</a></li>
    ...
    function showLoginAlert() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'http://localhost/project_ttcsn/auth/login.php';
            }
        });
    }
</script>
