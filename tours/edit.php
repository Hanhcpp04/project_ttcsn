...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $uploadDir = 'D:/xampp/htdocs/project_ttcsn/tours/uploads/';
        $webPath = 'uploads/';
        $imagePath = $tour['img'];
        ...
        if ($conn->query($updateSQL) === TRUE) {
            ...
            echo "<script>window.location.href = 'http://localhost/project_ttcsn/admin/dashboard.php?page=tours';</script>";
            exit;
        } else {
            echo "Lỗi: " . $conn->error;
        }
...
<div class="edit">
    <header>
        ...
        <a href="http://localhost/project_ttcsn/admin/dashboard.php?page=tours">Trở lại Danh sách Tour</a>
    </header>
    ...
    <main>
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            if (!empty($imagePath)) {
                ...
                $relativeImagePath = '/project_ttcsn/tours/' . $imagePath;

                $fullServerPath = 'D:/xampp/htdocs' . $relativeImagePath;
