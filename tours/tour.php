<?php
include 'D:\xampp\htdocs\project_ttcsn\includes\connect.php';
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            if ($result->num_rows > 0) {
                                while ($tour = $result->fetch_assoc()) {
                                    ...
                                    $imageHTML = '<img src="/project_ttcsn/template/images/placeholder.jpg" alt="No Image" class="w-12 h-12 object-cover rounded">';
                                    if (!empty($tour['img'])) {
                                        $imageName = basename($tour['img']);
                                        $fullImagePath = 'D:/xampp/htdocs/project_ttcsn/tours/uploads/' . $imageName;

                                        if (file_exists($fullImagePath)) {
                                            $imageHTML = "<img src='/project_ttcsn/tours/uploads/{$imageName}' alt='Tour Image' class='w-12 h-12 object-cover rounded'>";
                                        }
                                    }
                            ?>
